...
Commands:
  ...
  ${chalk.bold.whiteBright('[dev]')}        (dev)                   run dev server # hot-reload for pages, scripts, styles [DEFAULT]
  ${chalk.bold.whiteBright('production')}   (prod)                  run build and starts static server # optional, default, no hot reload on changes
