...
module.exports = {
	apply(){
		cogear.hooks.generators.theme.tap('generate theme',()=>this.generate())
	},
	generate(){
		...
		inquirer.prompt(questions).then(answers => {
			...
			let themeName = answers.name.replace('cogear-theme-','')
			let themePath = path.join(process.cwd(),'cogear-theme-'+themeName)
