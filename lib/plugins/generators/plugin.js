...
module.exports ={
	apply(){
		cogear.hooks.generators.plugin.tap('generate plugin',()=>this.generate())
	},
	generate(){
		...
		inquirer.prompt(questions).then(answers => {
			...
			let pluginName = answers.name.replace('cogear-plugin-','')
			let pluginPath = path.join(process.cwd(),'cogear-plugin-'+pluginName)
